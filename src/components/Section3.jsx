  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      ...
      <div className="relative w-full max-w-md ">
        ...
        <div>
          <img className='absolute  sm:top-0 left-4 top-5 h-12 w-12 sm:h-16 sm:w-16' src={quote2} alt="quote decoration" />
        </div>

        <div>
          <img className='absolute sm:bottom-0 right-4 bottom-5 h-12 w-12 sm:h-16 sm:w-16' src={quote1} alt="quote decoration" />
        </div>
